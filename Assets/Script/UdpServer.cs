...
public class UdpServer : MonoBehaviour
{
    ...
    void Update()
    {
        if (midiScript != null)
        {
            if(midiScript.press == true){
                sendStr = midiScript.noteNum;
                print("sendStr: " + sendStr.ToString());
                SocketSend(sendStr.ToString());
            } 
            else if(midiScript.press == false){
                SocketSend("OFF");
            }
        }else if (midiScript == null){
            Debug.Log("null");
        }

        // sendStr = cube.transform.position;
        //MIDI
        // sendStr = midiScript.noteNum;
        // print(sendStr.ToString());
        // SocketSend(sendStr.ToString());
